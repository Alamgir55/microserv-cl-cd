...
it("return a 404 if the provided id does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
...
it("updates the ticket provide valid inputs", () => __awaiter(void 0, void 0, void 0, function* () {
    const cookie = global.signin();
    const response = yield supertest_1.default(app_1.app)
        .post("/api/tickets")
        .set("Cookie", cookie)
    ...
    yield supertest_1.default(app_1.app)
        ...
        .expect(200);
    const ticketResponse = yield supertest_1.default(app_1.app)
